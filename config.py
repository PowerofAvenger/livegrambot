...
text_message = "Message forwarded to mods of LEGION ✅"#answering_text to user
banned = "you are blocked"#if admin has blocked a user
main_id = -647246334 #id without quotes #can be group id
TOKEN = "5028494199:AAG_rAqBw7eA9hdNSe84Pi7_fXNk7SC-Kyk"#bot token
